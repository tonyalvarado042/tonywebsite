...
const posts: BlogPost[] = [
  {
    ...
    content: [
      ...
      'La estadística no miente: la mayoría de quienes empiezan solos un programa de ciclismo lo abandonan antes de los 90 días. No porque el deporte sea difícil, sino porque la soledad del proceso y la falta de retroalimentación hacen que cualquier tropiezo parezca una señal para parar.',
  ...
  },
  {
    ...
    content: [
      ...
      'Esa historia no es solo la historia de Tony. Es la historia de lo que el movimiento físico puede hacer con una vida cuando se le da el espacio y el tiempo necesario. La ciencia respalda lo que miles de personas han vivido en su propia experiencia: el ejercicio físico regular genera cambios neurológicos, hormonales y cognitivos que transforman el estado de ánimo, la claridad mental, la autoestima y la capacidad de enfrentar el estrés. El cuerpo en movimiento es un cerebro diferente.',
