...
export const blogPosts: BlogPost[] = [
  {
    slug: 'como-encontrar-tu-proposito',
  ...
  {
    slug: 'como-empezar-a-entrenar-ciclismo',
  ...
  {
    slug: 'plan-de-entrenamiento-para-ciclistas',
  ...
  {
    slug: 'mountain-bike-en-costa-rica',
  ...
  {
    slug: 'resistencia-y-mentalidad-en-ciclismo',
  ...
  {
    slug: 'pure-cycling-entrenamiento-online',
  ...
  {
    slug: 'puromtb-comunidad-ciclista-costa-rica',
  ...
  {
    slug: 'bike-bed-hotels-turismo-deportivo',
  ...
  {
    slug: 'bicicleta-transformacion-personal',
  ...
  {
    slug: 'liderazgo-fe-emprendimiento',
